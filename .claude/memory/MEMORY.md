...
- [Online-Shop-Anbindung: Baufortschritt](project_shop_sync.md) — Phase 1-4 FERTIG; 🔴 2026-08-03 sort_order-Bug baueAchsenDimensionen() behoben (314 Artikel resynct); 🔴 2026-08-04 Grundpreis bei Variable Products: unit+unit_price.base gehören an den Vater, nicht die Variation (2 WC/Germanized-API-Eigenheiten, live end-to-end verifiziert per Carosello-Vergleich), 480 Väter zum Resync markiert
