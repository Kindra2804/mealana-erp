...
- [Online-Shop-Anbindung: Baufortschritt](project_shop_sync.md) — ✅ 2026-08-07: shop-gefilterter Bilder-Export fürs FTP (`bilder_export_fuer_shop.php`) + Live-Fortschritt übersteht Seiten-Reload (Migration 161); kleinere Shops (bio-wolle/sockenwolle) haben noch KEINE Kanal-Zuweisung — Jacky macht erst mealana fertig
