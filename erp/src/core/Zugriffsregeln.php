...
final class Zugriffsregeln
{
    ...
    private static array $regeln = [
        ...
        'bestellungen' => [
            ...
            'zahlung_speichern.php' => 'bestellwesen.bearbeiten',
        ...
        'einstellungen' => [
            ...
            'shop_sync_start.php'              => 'einstellungen.bearbeiten',
            'shop_sync_status.php'             => 'einstellungen.anzeigen',
            'shop_sync_pause.php'              => 'einstellungen.bearbeiten',
            'shop_sync_bilder_ftp_start.php'   => 'einstellungen.bearbeiten',
        ...
        'buchhaltung' => [
            ...
            'lieferantenrechnungen.php'     => 'buchhaltung.anzeigen',
