...
<form id="artikel-bearbeiten-form" action="aktualisieren.php" method="POST">
    ...
    <div class="gruppe">
        ...
        <textarea id="kurzbeschreibung" name="kurzbeschreibung" rows="2"><?= old('kurzbeschreibung', $formdata) ?></textarea>

        <label>Langbeschreibung</label>
        <textarea id="beschreibung" name="beschreibung" rows="6"><?= old('beschreibung', $formdata) ?></textarea>
