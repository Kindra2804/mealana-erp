...
$weEan       = $_SESSION['we_ean']       ?? '';
$weRueckkehr = $_SESSION['we_rueckkehr'] ?? '';
unset($_SESSION['we_ean'], $_SESSION['we_rueckkehr']);
...
<?php if ($weRueckkehr): ?>
    <div style="background:#f0f8ff;border-left:3px solid var(--color-nav);padding:8px 12px;border-radius:4px;margin-bottom:12px;font-size:13px">
        ← Artikel wird nach dem Speichern direkt im Wareneingang gebucht
    </div>
<?php endif; ?>
...
<form id="artikel-neu-form" action="speichern.php" method="POST">
    ...
    <?php if ($weRueckkehr): ?>
        ...
        <input type="hidden" name="we_ean" value="<?= htmlspecialchars($weEan) ?>">
    <?php endif; ?>
            ...
            <div class="form-row">
                ...
                <div style="display:flex;align-items:center;gap:var(--space-sm)">
                    <input type="text" name="ean_gtin13" id="ean_gtin13" class="erp-input" maxlength="13"
                        value="<?= old('ean_gtin13', $formdata, $weEan) ?>">
